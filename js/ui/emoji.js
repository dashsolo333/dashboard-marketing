// Sélecteur d'emoji pour l'icône d'un coup : un bouton qui montre l'emoji courant,
// une grille triée par thème, et un champ libre pour coller n'importe quel emoji.
import { h, icon } from './dom.js';

export const EMOJI_GROUPS = [
  { label: 'Contenu & réseaux', items: ['🎬', '📸', '🎥', '🎙️', '📝', '📰', '✉️', '📣', '📢', '🔔', '💬', '🧵', '📊', '🎨', '🖼️', '🎧', '🎵', '📺', '🔗', '🧲', '📱', '💻', '🗞️', '📌'] },
  { label: 'Foot & terrain', items: ['⚽', '🥅', '🏟️', '🏆', '🥇', '🥈', '🥉', '🎽', '👟', '🧤', '🏅', '⏱️', '📋', '🔥', '💪', '🤝', '🙌', '👏', '🧑‍🤝‍🧑', '👥', '🏃', '🤸', '🍕', '🍻'] },
  { label: 'Événement & business', items: ['🎉', '🎊', '🚀', '🎯', '🗓️', '📍', '🎟️', '🎁', '🛍️', '💸', '💰', '💳', '🏷️', '🌍', '✈️', '🏙️', '🏫', '🏢', '📦', '🛒', '🧾', '📈', '📉', '🤑'] },
  { label: 'Idées & humeur', items: ['💡', '✨', '⭐', '🌟', '⚡', '❤️', '😍', '😎', '🤩', '🥳', '👀', '🧠', '🕹️', '🛠️', '🧪', '🔒', '🎓', '🦄', '👑', '🌈', '☀️', '🌙', '❄️', '🎃'] },
];

/**
 * @param {{ value: string, disabled?: boolean, size?: 'md'|'lg', label?: string, onPick: (emoji: string) => void }} opts
 */
export function emojiPicker({ value = '', disabled = false, size = 'md', label = 'Icône du coup', onPick }) {
  let pop = null;
